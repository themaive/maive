...
function ServiceCard({service}) {
  ...
  return (
    <div className='m-2 w-90 bg-white h-120 p-4 py-2 flex justify-around align-center flex-col border-2 border-violet-400 rounded-2xl cursor-default hover:bg-violet-600 transition-colors text-black hover:text-white'>
