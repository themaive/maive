...
function Categories() {
    ...
    return (
        <div className="container mx-auto mt-10 flex justify-between items-center">
            <ul className='text-black flex justify-center items-center cursor-default'>
                {
                    categories.map((item)=> (
            ...
            <div onClick={handleShowFilter} className="relative p-2 bg-gray-50 hover:bg-violet-100">
                ...
                <ul className={`transition-colors absolute top-10 -left-40 text-black border-2 border-gray-50 ${showFilter ? 'block' : 'hidden'}`}>
